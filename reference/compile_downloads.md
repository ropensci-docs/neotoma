...
From the assemblage data for multiple cores, return a single data.frame
with columns for site metadata and assemblage data.
...
- downloads:
  ...
  [`get_download`](https://docs.ropensci.org/neotoma/reference/get_download.md),
  or multiple downloads joined in a list.
